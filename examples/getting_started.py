...
Get started with the MadDM command line interface, which is designed to resemble the familiar MadGraph command line structure.
...
See also :doc:`getting_started` for a more detailed introduction on the MadDM command line interface.
