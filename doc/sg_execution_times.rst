...
Computation times
=================
**00:00.348** total execution time for 6 files **from all galleries**:
...
.. container::
   ...
   * - :ref:`sphx_glr_tutorial_and_examples_relic_density.py` (``../examples/relic_density.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_tutorial_and_examples_scans.py` (``../examples/scans.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_tutorial_and_examples_scripts.py` (``../examples/scripts.py``)
     - 00:00.000
     - 0.0
