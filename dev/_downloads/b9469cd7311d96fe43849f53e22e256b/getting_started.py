...
.. code-block:: text
    ...
    | 2. Compute direct detection - nucleon recoil                 direct = OFF   |
    | 3. Compute direct detection - electron recoil       direct_electron = ON    |
    ...
    * Enter set NAME value to change any parameter to the requested value
    /=============================================================================\ 
    |  6. Edit the model parameters    [param]                                    |  
    |  7. Edit the MadDM options       [maddm]                                    |
    \=============================================================================/
    [60s to answer]
...
If your model has both DM-nucleon and DM-electron interactions, you can set both ``direct`` and ``direct_electron`` modules to ON,
