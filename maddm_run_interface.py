...
class Spectra:
    ...
    def __init__(self):
        ...
        self.spectra       = {'log10x': [], 'x':[], 'antideuterons_spherical':[],'antideuterons_AWF':[],'antideuterons_GWF':[], 'antideuterons_GWF_pvalue':[], 'antideuterons_pcoalsigma':[], 'antideuterons_pcoal':[], 'antideuterons':[], 'antiprotons':[], 'gammas':[], 'neutrinos_e':[], 'neutrinos_mu':[], 'neutrinos_tau':[], 'positrons':[] }
        self.errors       = { 'antideuterons_spherical':[],'antihelions3_spherical':[],'antihelions4_spherical':[],'antideuterons_AWF':[],'antideuterons_GWF':[], 'antideuterons_GWF_pvalue':[], 'antideuterons_pcoalsigma':[], 'antideuterons_pcoal':[], 'antideuterons':[], 'antiprotons':[], 'gammas':[], 'neutrinos_e':[], 'neutrinos_mu':[], 'neutrinos_tau':[], 'positrons':[] }
        ...
        self.flux_source   = {'e':[] , 'antideuterons_spherical':{'dNdE':[]},'antideuterons_AWF':{'dNdE':[]},'antideuterons_GWF':{'dNdE':[]},'antideuterons_GWF_pvalue':{'dNdE':[]}, 'antideuterons_pcoalsigma':{'dNdE':[]}, 'antideuterons_pcoal':{'dNdE':[]}, 'antideuterons': {'dNdE':[]}, 'positrons': {'dNdE':[]}, 'antiprotons': {'dNdE':[] } , 
