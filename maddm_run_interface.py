...
class Spectra:
    ...
    def __init__(self):
        ...
        self.spectra_id    = {'He3x':'antihelions3','He4x':'antihelions4','Dx':'antideuterons', 'DxS':'antideuterons_spherical', 'DxGWF':'antideuterons_GWF', 'DxAWF':'antideuterons_AWF', 'DxGWFp':'antideuterons_GWF_pvalue', 'Dxpcoals':'antideuterons_pcoalsigma', 'Dxpcoal':'antideuterons_pcoal', 'px':'antiprotons', 'pxP':'antiprotonsP', 'gx':'gammas', 'nuex':'neutrinos_e', 'numux':'neutrinos_mu', 'nutaux':'neutrinos_tau', 'ex':'positrons'}
        ...
        self.spectra       = {'log10x': [], 'x':[], 'antihelions3_spherical':[], 'antihelions4_spherical':[], 'antideuterons_spherical':[],'antideuterons_AWF':[],'antideuterons_GWF':[], 'antideuterons_GWF_pvalue':[], 'antideuterons_pcoalsigma':[], 'antideuterons_pcoal':[], 'antideuterons':[], 'antiprotons':[], 'antiprotonsPrimordial':[], 'gammas':[], 'neutrinos_e':[], 'neutrinos_mu':[], 'neutrinos_tau':[], 'positrons':[] }
        self.errors       = { 'antideuterons_spherical':[],'antihelions3_spherical':[],'antihelions4_spherical':[],'antideuterons_AWF':[],'antideuterons_GWF':[], 'antideuterons_GWF_pvalue':[], 'antideuterons_pcoalsigma':[], 'antideuterons_pcoal':[], 'antideuterons':[], 'antiprotons':[], 'antiprotonsPrimordial':[], 'gammas':[], 'neutrinos_e':[], 'neutrinos_mu':[], 'neutrinos_tau':[], 'positrons':[] }
        ...
        self.flux_source   = {'e':[] , 'antihelions3_spherical':{'dNdE':[]}, 'antihelions4_spherical':{'dNdE':[]}, 'antideuterons_spherical':{'dNdE':[]},'antideuterons_AWF':{'dNdE':[]},'antideuterons_GWF':{'dNdE':[]},'antideuterons_GWF_pvalue':{'dNdE':[]}, 'antideuterons_pcoalsigma':{'dNdE':[]}, 'antideuterons_pcoal':{'dNdE':[]}, 'antideuterons': {'dNdE':[]}, 'positrons': {'dNdE':[]}, 'antiprotons': {'dNdE':[] }, 'antiprotonsPrimordial': {'dNdE':[] } , 
