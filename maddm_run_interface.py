...
class Spectra:
    ...
    def __init__(self):
        ...
        self.spectra       = {'log10x': [], 'x':[], 'antideuterons_GWF':[], 'antideuterons_pcoalsigma':[], 'antideuterons_pcoal':[], 'antideuterons':[], 'antiprotons':[], 'gammas':[], 'neutrinos_e':[], 'neutrinos_mu':[], 'neutrinos_tau':[], 'positrons':[] }
        self.errors       = { 'antideuterons_GWF':[], 'antideuterons_pcoalsigma':[], 'antideuterons_pcoal':[], 'antideuterons':[], 'antiprotons':[], 'gammas':[], 'neutrinos_e':[], 'neutrinos_mu':[], 'neutrinos_tau':[], 'positrons':[] }

        # this contains the spectrua converted to E and dN/dE (needed by DRAGON)
        self.flux_source   = {'e':[] , 'antideuterons_GWF':{'dNdE':[]}, 'antideuterons_pcoalsigma':{'dNdE':[]}, 'antideuterons_pcoal':{'dNdE':[]}, 'antideuterons': {'dNdE':[]}, 'positrons': {'dNdE':[]}, 'antiprotons': {'dNdE':[] } , 
